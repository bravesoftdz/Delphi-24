...
uses
  ...
  cxDBEdit, dmDados, dxSkinscxPCPainter, dxBarBuiltInMenu, cxPC;
...
begin
  dmDesbravador.DataSource_Unidades.DataSet.Cancel;
end;

procedure TfrmUnidades.btnExcluirClick(Sender: TObject);
begin
  dmDesbravador.DataSource_Unidades.DataSet.Delete;
end;
...
begin
  dmDesbravador.DataSource_Unidades.DataSet.Post;
end;
