...
begin
  dmDesbravador.DataSource_Clube.DataSet.Cancel;
end;

procedure TfrmClube.btnExcluirClick(Sender: TObject);
begin
  dmDesbravador.DataSource_Clube.DataSet.Delete;
end;

procedure TfrmClube.btnIncluirClick(Sender: TObject);
begin
  dmDesbravador.DataSource_Clube.DataSet.Close;
  dmDesbravador.DataSource_Clube.DataSet.Open;
  dmDesbravador.DataSource_Clube.DataSet.Insert;
end;

procedure TfrmClube.btnSalvarClick(Sender: TObject);
begin
  dmDesbravador.DataSource_Clube.DataSet.Post;
end;
